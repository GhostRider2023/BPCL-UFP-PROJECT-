...
# Dormand-Prince RK45 and 1-D interpolation in NumPy alone. SciPy is 118 MB and
# a Vercel function has 250 MB for everything; see numerics.py for why RK45 is
# the right substitute for LSODA on this system, and validate_against_scipy.py
# for the proof that it is.
from numerics import interp1d, solve_ivp
